...
| HTTP request                                                       | Method             | Description                              | Request parameters | Request body | Response example                                                 |
|--------------------------------------------------------------------|--------------------|------------------------------------------|--------------------|--------------|------------------------------------------------------------------|
| **GET** `/events/{eventId}/comments`                               | `getEventComments` | Получить публичные комментарии к событию | `eventId` — путь   | —            | `json [ { "id": 1, "text": "Публичный комментарий" } ] `         |
| **GET** `/comments/{commentId}`                                    | `getComment`       | Получить конкретный комментарий по ID    | `commentId` — путь | —            | `json { "id": 1, "text": "Комментарий", "authorName": "user" } ` |

**Admin**

| HTTP request                                                       | Method             | Description                                                         | Request parameters                                                                                                                                                                                                        | Request body                                | Response example                                                                                             |
|--------------------------------------------------------------------|--------------------|---------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|--------------------------------------------------------------------------------------------------------------|
| **GET** `/admin/comments`                                          | `getComments`      | Получить комментарии по фильтрам (поиск, даты, авторы, события, ID) | <ul><li>`text=поиск`</li><li>`usersIds=1,2`</li><li>`eventsIds=10`</li><li>`commentsIds=5,6`</li><li>`rangeStart=2025-04-01 00:00:00`</li><li>`rangeEnd=2025-05-01 00:00:00`</li><li>`from=0`</li><li>`size=10`</li></ul> | —                                           | `json [ { "id": 1, "text": "Комментарий модерации" } ] `                                                     |
| **PATCH** `/admin/comments/{commentId}`                            | `updateComment`    | Обновить комментарий администратором                                | `commentId` — путь                                                                                                                                                                                                        | `json { "text": "Исправленный текст" } `    | `json { "id": 1, "text": "Исправленный текст" } `                                                            |
| **DELETE** `/admin/comments/{commentId}`                           | `deleteComment`    | Удалить комментарий администратором                                 | `commentId` — путь                                                                                                                                                                                                        | —                                           | —                                                                                                            |

**Private**

| HTTP request                                                       | Method             | Description                                                         | Request parameters                                                                                                                                                                                                        | Request body                                | Response example                                                                                             |
|--------------------------------------------------------------------|--------------------|---------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------|--------------------------------------------------------------------------------------------------------------|
| **POST** `/users/{userId}/events/{eventId}/comments`               | `createComment`    | Добавить комментарий к событию от имени пользователя                | `userId`, `eventId` — путь                                                                                                                                                                                                | `json { "text": "Отличное мероприятие!" } ` | `json { "id": 1, "text": "Отличное мероприятие!", "authorName": "user", "created": "2025-05-02T15:00:00" } ` |
| **GET** `/users/{userId}/events/{eventId}/comments`                | `getEventComments` | Получить комментарии к событию (от имени пользователя)              | `userId`, `eventId` — путь                                                                                                                                                                                                | —                                           | `json [ { "id": 1, "text": "Классно!" } ] `                                                                  |
| **PATCH** `/users/{userId}/events/{eventId}/comments/{commentId}`  | `updateComment`    | Обновить комментарий пользователя                                   | `userId`, `eventId`, `commentId` — путь                                                                                                                                                                                   | `json { "text": "Обновлённый текст" } `     | `json { "id": 1, "text": "Обновлённый текст" } `                                                             |
| **DELETE** `/users/{userId}/events/{eventId}/comments/{commentId}` | `deleteComment`    | Удалить комментарий пользователя                                    | `userId`, `eventId`, `commentId` — путь                                                                                                                                                                                   | —                                           | —                                                                                                            |
| **GET** `/users/{userId}/events/{eventId}/comments/{commentId}`    | `getComment`       | Получить конкретный комментарий пользователя                        | `userId`, `eventId`, `commentId` — путь                                                                                                                                                                                   | —                                           | `json { "id": 1, "text": "Комментарий", "created": "..." } `                                                 |
